...
urlpatterns = [
    ...
    path('ApiGetCoursSessionDetails', ApiGetCoursSessionDetails, name="ApiGetCoursSessionDetails"),
    path('ApiEditCoursSession', ApiEditCoursSession, name="ApiEditCoursSession"),
