...
class LignesDevis(models.Model):
    ...
    unite = models.CharField(max_length=20, choices=[('jour', 'Jour'), ('groupe', 'Groupe'), ('participant', 'Participant'), ('heure', 'Heure')], default='participant', help_text="Unité de facturation")
