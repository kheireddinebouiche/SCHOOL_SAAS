...
def ApiGetSessionDetails(request):
    ...
    session_lines = SessionExamLine.objects.filter(session_id=session_id).values(
        'id', 'groupe__nom','groupe__id','semestre','date_debut','date_fin','status',
        'groupe__specialite__label', 'groupe__specialite__formation__nom'
    )
