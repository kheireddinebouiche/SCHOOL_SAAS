    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_formation', models.CharField(blank=True, choices=[('etrangere', 'Formation étrangère'), ('national', 'Formation Etatique')], default='national', max_length=100, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('prix_rachat_credit', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('penalite_retard', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('is_archived', models.BooleanField(default=False)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etat', models.CharField(blank=True, choices=[('last', 'À jour'), ('updated', 'Mis à jour')], default='last', max_length=10, null=True)),
