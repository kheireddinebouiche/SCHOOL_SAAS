        ...
        try:
            ...
            for combinaison in combinaisons:
                ...
                combinaison_data = {
                    ...
                    'specialite1_code': combinaison.specialite1.code if combinaison.specialite1 else 'N/A',
                    'specialite1_version': combinaison.specialite1.version if combinaison.specialite1 else 'N/A',
                    ...
                    'specialite2_code': combinaison.specialite2.code if combinaison.specialite2 else 'N/A',
                    'specialite2_version': combinaison.specialite2.version if combinaison.specialite2 else 'N/A',
...
def ApiGetSpecialitesFromCombinaison(request):
    if request.method == "GET":
        ...
        data_specialite.append({
            ...
            'specialite_1' : f"{obj.specialite1.label} ({obj.specialite1.version})" if obj.specialite1.version else obj.specialite1.label,
            'specialite_2' : f"{obj.specialite2.label} ({obj.specialite2.version})" if obj.specialite2.version else obj.specialite2.label,
