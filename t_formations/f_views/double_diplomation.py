        ...
        try:
            ...
            for combinaison in combinaisons:
                combinaison_data = {
                    ...
                    'specialite2_label': f"{combinaison.specialite2.label} ({combinaison.specialite2.version})" if combinaison.specialite2 and combinaison.specialite2.version else (combinaison.specialite2.label if combinaison.specialite2 else 'N/A'),
