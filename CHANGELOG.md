...
\n- Ajout du champ 'Catégorie de produit' dans la fenêtre modale de modification des autres paiements.
\n- Harmonisation du design de la fenêtre modale de modification des autres paiements avec le thème premium de la page (arrondis, ombres, icônes dans les champs).

- Mise � jour: Les entreprises cr��es dans le CRM sont maintenant visibles dans CRM (Liste des prospects) et dans Conseil (Prospects en instance).

- Correction: Cr�ation automatique d'un contact principal (ContactEntreprise) lors de l'ajout d'une entreprise via crm/inscription-entreprise/ afin d'harmoniser avec conseil/prospects-en-instance/.

- Correction: R�solution de l'erreur TypeError (is_main vers is_primary) lors de la cr�ation d'un contact entreprise dans InscriptionEntreprise.
