...
class Entreprise(models.Model):
    ...
    agrement = models.CharField(max_length=100, null=True, blank=True)
...
class GlobalConfiguration(models.Model):
    ...
    crm_field_locks = models.JSONField(default=dict, blank=True, verbose_name=_("Verrouillage des champs CRM"))
    crm_required_fields_national = models.JSONField(default=dict, blank=True, verbose_name=_("Champs requis CRM (National)"))
    crm_required_fields_etranger = models.JSONField(default=dict, blank=True, verbose_name=_("Champs requis CRM (Etranger)"))
    crm_required_fields_double = models.JSONField(default=dict, blank=True, verbose_name=_("Champs requis CRM (Double Diplomation)"))
    ...
    bypass_preinscrit_verification = models.BooleanField(default=False, verbose_name=_("Désactiver la vérification du dossier (validation directe)"))
