    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tage', models.CharField(blank=True, choices=[('important', 'Important'), ('a_revoir', 'A revoir'), ('a_contacte', 'À contacter'), ('a_relancer', 'À relancer')], max_length=255, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_prospect', models.CharField(choices=[('particulier', 'Particulier'), ('entreprise', 'Entreprise'), ('autre', 'Autre')], max_length=255, null=True)),
                ('canal', models.CharField(choices=[('web', 'Recherche sur le web'), ('recommandation', 'Recommandation'), ('email', 'Email'), ('telephone', 'Téléphone'), ('facebook', 'Facebook'), ('linkedin', 'LinkedIn'), ('instagram', 'Instagram'), ('tiktok', 'TikTok'), ('bouche-a-oreille', 'Bouche à oreille'), ('site', 'Site Web'), ('prospectus', 'Prospectus'), ('pub', 'Publicité'), ('autre', 'Autre')], max_length=255, null=True)),
                ...
                ('poste_dans_entreprise', models.CharField(blank=True, choices=[('salarie', 'Salarié'), ('responsable', 'Responsable'), ('directeur', 'Directeur'), ('gerant', 'Gérant')], max_length=100, null=True)),
                ...
                ('statut', models.CharField(blank=True, choices=[('visiteur', 'Visiteur'), ('prinscrit', 'Pré-inscrit'), ('instance', 'Instance de paiement'), ('convertit', 'Convertit'), ('annuler', 'Inscription Annulée')], default='visiteur', max_length=100, null=True)),
                ...
                ('contact_situation', models.CharField(blank=True, choices=[('fist_contact', 'Premier passage'), ('a_appeler', 'Après Appel'), ('est_passer', 'Après visite')], max_length=100, null=True)),
