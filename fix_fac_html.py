...
# 4. Update the logic inside addItemBtn listener
# It's better to just replace the whole finalizeAddItem block like we did for devis.
# We will do it in steps. First, let's inject const u = document.getElementById('newUnit').value;
