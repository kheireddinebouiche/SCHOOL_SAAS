...
from .views import (
    ...
    saas_toggle_tenant_active_view, saas_toggle_tenant_portail_view, saas_tenant_data_summary_view, saas_tenant_data_explorer_view,
...
urlpatterns = [
    ...
    path('api/tenant/<int:tenant_id>/toggle-portail/', saas_toggle_tenant_portail_view, name='saas_toggle_tenant_portail'),
